...
############################################
file_name = "train_ParkAndGround"
root_file = "E:\\MachineLearning-data\\Buildings\\"
end_formual = ".csv"
...
nn = NeuralNetwork([24,56,4],'logistic')  
...
ax1.scatter(x2, y2, z2, c='g', marker='o')
...
# with open(r'E:\train_ParkAndGround_finall.csv','w',newline='') as f:
